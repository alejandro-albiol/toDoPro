...
class TaskDetail {
    ...
    static handleSubmit(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const updatedTask = Object.assign(Object.assign({}, this.task), { title: form.querySelector('input[name="title"]')
                        .value, description: form.querySelector('textarea[name="description"]').value, completed: form.querySelector('input[name="completed"]:checked') !== null });
